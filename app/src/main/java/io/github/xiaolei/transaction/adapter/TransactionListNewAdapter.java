 ...
 */
public class TransactionListNewAdapter extends NewGenericRecyclerViewAdapter<Transaction, TransactionListNewAdapter.ViewHolder> implements GenericRecyclerViewAdapter.OnRecyclerViewItemClickListener {
